...
import 'package:attendance_app/src/github_gql/github_queries.ast.gql.dart'
    as _i2;
import 'package:attendance_app/src/github_gql/github_queries.var.gql.dart'
    as _i3;
import 'package:attendance_app/third_party/github_graphql_schema/serializers.gql.dart'
    as _i4;
...
abstract class GViewerDetail
  ...
  static void _initializeBuilder(GViewerDetailBuilder b) => b
    ..operation =
        const _i1.Operation(document: _i2.document, operationName: 'ViewerDetail');
